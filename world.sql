...
--
-- Name: city; Type: TABLE; Schema: public; Owner: samulisuortti; Tablespace: 
--
...
ALTER TABLE city OWNER TO samulisuortti;

--
-- Name: country; Type: TABLE; Schema: public; Owner: samulisuortti; Tablespace: 
--
...
ALTER TABLE country OWNER TO samulisuortti;

--
-- Name: language; Type: TABLE; Schema: public; Owner: samulisuortti; Tablespace: 
--
...
ALTER TABLE language OWNER TO samulisuortti;

--
-- Data for Name: city; Type: TABLE DATA; Schema: public; Owner: samulisuortti
--
...
--
-- Data for Name: country; Type: TABLE DATA; Schema: public; Owner: samulisuortti
--

COPY country (code, name, continent, region, surface_area, independence_year, population, life_expectancy, gnp, gnp_old, local_name, government_form, head_of_state, capital_id, code2) FROM stdin;
...
--
-- Data for Name: language; Type: TABLE DATA; Schema: public; Owner: samulisuortti
--

COPY language (country_code, language, is_official, percentage) FROM stdin;
...
--
-- Name: city_pkey; Type: CONSTRAINT; Schema: public; Owner: samulisuortti; Tablespace: 
--
...
--
-- Name: country_pkey; Type: CONSTRAINT; Schema: public; Owner: samulisuortti; Tablespace: 
--
...
--
-- Name: countrylanguage_pkey; Type: CONSTRAINT; Schema: public; Owner: samulisuortti; Tablespace: 
--

ALTER TABLE ONLY language
    ADD CONSTRAINT countrylanguage_pkey PRIMARY KEY (country_code, language);


--
-- Name: country_capital_fkey; Type: FK CONSTRAINT; Schema: public; Owner: samulisuortti
--

ALTER TABLE ONLY country
    ADD CONSTRAINT country_capital_fkey FOREIGN KEY (capital_id) REFERENCES city(id);


--
-- Name: countrylanguage_countrycode_fkey; Type: FK CONSTRAINT; Schema: public; Owner: samulisuortti
--

ALTER TABLE ONLY language
    ADD CONSTRAINT countrylanguage_countrycode_fkey FOREIGN KEY (country_code) REFERENCES country(code);


--
-- Name: public; Type: ACL; Schema: -; Owner: samulisuortti
--

REVOKE ALL ON SCHEMA public FROM PUBLIC;
REVOKE ALL ON SCHEMA public FROM samulisuortti;
GRANT ALL ON SCHEMA public TO samulisuortti;
